...
| Case differential-verified | 52 个（72 个 runtime） |
...
| 未关联 runtime | 1,506 个 |
| 关联覆盖率 | 63.6% |
| Representative scenario | 52/52 通过 |
| NFR | 0 个已验证 |
