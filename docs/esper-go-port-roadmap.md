...
| Capability | 110 个 |
| Case | 440 个 |
| Case implemented（verification） | 440 个（其中 53 个 differential-verified、18 个 intentionally-different） |
| Case differential-verified | 53 个（74 个 runtime） |
...
| 未关联 runtime | 1,506 个 |
| 关联覆盖率 | 63.6% |
| Representative scenario | 53/53 通过 |
| NFR | 0 个已验证 |
