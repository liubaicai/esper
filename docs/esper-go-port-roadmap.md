...
| Capability | 110 个 |
| Case | 410 个 |
| Case implemented（verification） | 409 个（其中 23 个 differential-verified、18 个 intentionally-different） |
| Case differential-verified | 23 个（33 个 runtime） |
| Case intentionally-different | 18 个 |
| Case inventoried-only | 1 个 |
