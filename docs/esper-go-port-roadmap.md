...
| Capability | 110 个 |
| Case | 426 个 |
| Case implemented（verification） | 426 个（其中 39 个 differential-verified、18 个 intentionally-different） |
| Case differential-verified | 39 个（49 个 runtime） |
...
| 未关联 runtime | 1,506 个 |
| 关联覆盖率 | 63.6% |
| Representative scenario | 39/39 通过 |
| NFR | 0 个已验证 |
