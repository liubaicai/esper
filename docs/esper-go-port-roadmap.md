...
| Capability | 110 个 |
| Case | 441 个 |
| Case implemented（verification） | 441 个（其中 52 个 differential-verified、18 个 intentionally-different） |
| Case differential-verified | 52 个（75 个 runtime） |
...
| 未关联 runtime | 1,506 个 |
| 关联覆盖率 | 63.6% |
| Representative scenario | 54/54 通过 |
| NFR | 0 个已验证 |
