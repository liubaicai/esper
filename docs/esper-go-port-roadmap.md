...
| Case differential-verified | 14 个（21 个 runtime） |
...
| 未关联 runtime | 1,854 个 |
| 关联覆盖率 | 55.1% |
| Representative scenario | 14/14 通过 |
| NFR | 0 个已验证 |
