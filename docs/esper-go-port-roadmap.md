...
| Case differential-verified | 13 个（20 个 runtime） |
...
| 未关联 runtime | 1,854 个 |
| 关联覆盖率 | 55.1% |
| Representative scenario | 13/13 通过 |
| NFR | 0 个已验证 |
