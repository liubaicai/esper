...
## 0. 实时状态入口
> 最新补充：Draft 4.282（2026-08-29），新增 `resultset-querytype-row-for-all-having-sum-one` differential-verified 场景，对照固定 Java `ResultSetQueryTypeRowForAllHaving.java` ordinal 0 的 `ResultSetQueryTypeRowForAllWHavingSumOneView`（runtime `java-runtime-65e4ba1499cb12f04d8a`；shared inventory `java-45a56190252ed051c35f`；static candidate `java-52f40599a0c7dc213c2b`，无 flags）：Java/Go 各 3 条 records、0 differences。场景覆盖 10 秒 time-window `sum(longBoxed) > 10` 的 `irstream`/old-stream、t5/t8/t10 新旧行与 10 秒淘汰（t5 new 25、t8 new 20/old 25、t10 old 20）；typed Go `LongBoxed`、`TimeWindow`、`Sum`、`Having`、`WithOldStream` 与严格 scenario/oracle validator 固定 payload、metadata、value/order/time/record-shape，manifest 更新为 574 cases、187 个 differential-verified case、712 个 differential runtime IDs、3333 条 associations（referenced 3120）；capability 119 个（34 DV）。
