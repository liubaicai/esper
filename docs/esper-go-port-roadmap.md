...
| Case differential-verified | 16 个（23 个 runtime） |
...
| 未关联 runtime | 1,853 个 |
| 关联覆盖率 | 55.1% |
| Representative scenario | 16/16 通过 |
| NFR | 0 个已验证 |
