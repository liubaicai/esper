...
| Case differential-verified | 46 个（55 个 runtime） |
...
| 未关联 runtime | 1,506 个 |
| 关联覆盖率 | 63.6% |
| Representative scenario | 46/46 通过 |
| NFR | 0 个已验证 |
