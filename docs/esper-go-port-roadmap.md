...
| Capability | 118 个 |
| Case | 560 个 |
| Case implemented（verification） | 558 个（其中 172 个 differential-verified、23 个 intentionally-different） |
| Case differential-verified | 172 个（684 个 runtime） |
...
| 未关联 runtime | 1,034 个 |
| 关联覆盖率 | 75.0% |
| Representative scenario | 99/99 通过 |
| NFR | 0 个已验证 |
