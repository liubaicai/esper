...
> 最新补充：Draft 3.69（2026-08-11），PatternGuardWhile suite 4/4 关闭（4 个新增 runtime ID）：新增 AST 级表达式 guard（patternGuardWhileNode + PatternStream.WhileGuard），对齐 ExpressionGuard inspect 语义——true 放行、Boolean.FALSE 永久退出并向上 evaluateFalse、null 仅吞没；Simple/PatternOp（5 子用例含 SODA 等价形态）/PatternVariable/PatternInvalid 全部通过。当前 288 mapped / 1 partial / 17 approved-difference。本轮不需要 MySQL Docker。
>
...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.69，Client domain 100% 关闭（281/281）；View domain 22 个唯一 runtime，Pattern domain 79 个（And/Or 7、EveryDistinct 17/17、MatchUntil 9/9、ObserverTimerAt 10/10、ObserverTimerInterval 8/8、ObserverTimerSchedule 7/7+TZ 1/1、GuardWhile 4/4、ConsumingPattern 10/10、CompositeSelect 2/2、Every 6/6、Not 6/6、FollowedBy 10/10）；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,015 条关联、1,979/4,140 唯一 runtime（47.80%）、288 mapped / 1 partial / 17 approved-difference；下一步 Pattern 基础 suite（ComplexPropertyAccess 批量、FollowedByMax 剩余、RepeatRoute/StartStop）与 View Expression/Accum 系列、ExprFilter 剩余 |
