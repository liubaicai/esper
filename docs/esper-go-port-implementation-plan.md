...
> 最新补充：Draft 3.72（2026-08-11），PatternRepeatRouteEvent 3/3 与 PatternStartStop 3/3 关闭（6 个新增 runtime ID）：RepeatRoute 验证 subscriber 回调内事件路由循环（1000/级联/timer 触发）；StartStop 验证 deploy/undeploy/redeploy 与 Statement.Start/Stop 生命周期。当前 293 mapped / 1 partial / 17 approved-difference。本轮不需要 MySQL Docker。
>
...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.72，Client domain 100% 关闭（281/281）；View domain 22 个唯一 runtime，Pattern domain 92 个（And/Or 7、EveryDistinct 17/17、MatchUntil 9/9、ObserverTimerAt 10/10、ObserverTimerInterval 8/8、ObserverTimerSchedule 7/7+TZ 1/1、GuardWhile 4/4、ComplexPropertyAccess 5/5、OperatorMix 1/1、DeadPattern 1/1、RepeatRoute 3/3、StartStop 3/3、ConsumingPattern 10/10、CompositeSelect 2/2、Every 6/6、Not 6/6、FollowedBy 10/10）；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,028 条关联、1,992/4,140 唯一 runtime（48.12%）、293 mapped / 1 partial / 17 approved-difference；下一步 Pattern 基础 suite（FollowedByMax 剩余、ExpressionText、SuperAndInterfaces、StartLoop）与 View Expression/Accum 系列、ExprFilter 剩余 |
