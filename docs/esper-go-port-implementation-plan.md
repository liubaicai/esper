...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.60，Client domain 100% 关闭（281/281）；View domain 22 个唯一 runtime，Pattern domain 17 个（And/Or 3、CompositeSelect 2/2、Every 6/6、Not 6/6）；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 1,953 条关联、1,918/4,140 唯一 runtime（46.33%）、279 mapped / 1 partial / 17 approved-difference；下一步 Pattern 基础 suite（FollowedBy/EveryDistinct/MatchUntil 批量）与 View Expression/Accum 系列、ExprFilter 剩余 |
