...
> 最新补充：Draft 3.83（2026-08-12），ViewGroup/ViewIntersect 基础子集关闭：GroupWindow 分组长度/时间窗口、数组键以及 Intersect child retention，复用 5 个已有 parity 测试。Coverage 2,067/4,140（49.93%），325 case 中 307 mapped。下一步 ViewGroup/ViewIntersect 剩余矩阵、ExprFilter 剩余。本轮不需要 MySQL Docker。
>
