...
> 最新补充：Draft 3.71（2026-08-11），PatternOperatorOperatorMix 与 PatternDeadPattern 两 suite 关闭（各 1 个 runtime ID）：OperatorMix 7 个 W-harness 子用例（含 SODA 等价）覆盖 and/or/followed-by 算子优先级组合；DeadPattern 一千部署被 C 证伪后 A 遍历须廉价零触发。当前 291 mapped / 1 partial / 17 approved-difference。本轮不需要 MySQL Docker。
>
...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.71，Client domain 100% 关闭（281/281）；View domain 22 个唯一 runtime，Pattern domain 86 个（And/Or 7、EveryDistinct 17/17、MatchUntil 9/9、ObserverTimerAt 10/10、ObserverTimerInterval 8/8、ObserverTimerSchedule 7/7+TZ 1/1、GuardWhile 4/4、ComplexPropertyAccess 5/5、OperatorMix 1/1、DeadPattern 1/1、ConsumingPattern 10/10、CompositeSelect 2/2、Every 6/6、Not 6/6、FollowedBy 10/10）；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,022 条关联、1,986/4,140 唯一 runtime（47.97%）、291 mapped / 1 partial / 17 approved-difference；下一步 Pattern 基础 suite（FollowedByMax 剩余、RepeatRoute/StartStop、SuperAndInterfaces、StartLoop）与 View Expression/Accum 系列、ExprFilter 剩余 |
