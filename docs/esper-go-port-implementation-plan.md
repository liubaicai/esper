...
- 当前 capability manifest 已关联 1,318/4,136 个唯一 Java runtime（约 31.86% 的 Java runtime 对账/处置进度）；189 个 case 中 183 个 mapped、2 个 partial、4 个 approved-difference。该比例不是 Java/Go 行为 parity 通过率，也不是全量移植完成度。
