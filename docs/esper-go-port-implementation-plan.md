...
> 最新补充：Draft 3.70（2026-08-11），PatternComplexPropertyAccess suite 5/5 关闭（5 个新增 runtime ID）：Esper 属性路径（mapped/indexed/nested）在链式 filter 中映射为组合表达式 MapValue/ArrayAt/Property；16 个 ComplexProperties 子用例（含越界与缺失键零触发对照）+ IndexedFilterProp + IndexedValueProp（OM/Compile/EPL 三前端子用例）全部通过。当前 289 mapped / 1 partial / 17 approved-difference。本轮不需要 MySQL Docker。
>
...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.70，Client domain 100% 关闭（281/281）；View domain 22 个唯一 runtime，Pattern domain 84 个（And/Or 7、EveryDistinct 17/17、MatchUntil 9/9、ObserverTimerAt 10/10、ObserverTimerInterval 8/8、ObserverTimerSchedule 7/7+TZ 1/1、GuardWhile 4/4、ComplexPropertyAccess 5/5、ConsumingPattern 10/10、CompositeSelect 2/2、Every 6/6、Not 6/6、FollowedBy 10/10）；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,020 条关联、1,984/4,140 唯一 runtime（47.92%）、289 mapped / 1 partial / 17 approved-difference；下一步 Pattern 基础 suite（FollowedByMax 剩余、RepeatRoute/StartStop、SuperAndInterfaces、DeadPattern）与 View Expression/Accum 系列、ExprFilter 剩余 |
