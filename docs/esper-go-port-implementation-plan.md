...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.73，Client domain 100% 关闭（281/281）；View domain 22 个唯一 runtime，Pattern domain 98 个（And/Or 7、EveryDistinct 17/17、MatchUntil 9/9、ObserverTimerAt 10/10、ObserverTimerInterval 8/8、ObserverTimerSchedule 7/7+TZ 1/1、GuardWhile 4/4、ComplexPropertyAccess 5/5、OperatorMix 1/1、DeadPattern 1/1、RepeatRoute 3/3、StartStop 3/3、UseResult 6/6、ConsumingPattern 10/10、CompositeSelect 2/2、Every 6/6、Not 6/6、FollowedBy 10/10）；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,034 条关联、1,998/4,140 唯一 runtime（48.26%）、294 mapped / 1 partial / 17 approved-difference；下一步 Pattern 基础 suite（FollowedByMax 剩余、ExpressionText、SuperAndInterfaces、StartLoop）与 View Expression/Accum 系列、ExprFilter 剩余 |
