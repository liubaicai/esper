...
> 最新补充：Draft 3.82（2026-08-12），ViewLengthBatch 子集（SceneOne/Size2/Size1）与 ViewUnionFirstUniqueAndFirstLength 关闭，新增 4 个 parity 测试。LengthBatch 对齐整批 new/old 和 iterator 当前批；Union 对齐 child retention 。Coverage 2,067/4,140（49.93%），323 case 中 305 mapped。下一步 ViewGroup/Intersect 和 ExprFilter 剩余。本轮不需要 MySQL Docker。
>
