...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.67，Client domain 100% 关闭（281/281）；View domain 22 个唯一 runtime，Pattern domain 67 个（And/Or 7、EveryDistinct 17/17、MatchUntil 9/9、ObserverTimerAt 10/10、ObserverTimerInterval 8/8、ConsumingPattern 10/10、CompositeSelect 2/2、Every 6/6、Not 6/6、FollowedBy 10/10）；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,003 条关联、1,968/4,140 唯一 runtime（47.54%）、286 mapped / 1 partial / 17 approved-difference；下一步 Pattern 基础 suite（ObserverTimerSchedule、GuardWhile、ComplexPropertyAccess 批量）与 View Expression/Accum 系列、ExprFilter 剩余 |
