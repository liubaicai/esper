...
当前切片（Draft 3.86，2026-08-12）关闭 ViewGroup 的 12 个 execution 与 ViewIntersect 的 6 个 execution；新增 grouped/intersect fluent parity 矩阵，并修复 `GroupWindow + Aggregate` 按 groupwin key 隔离状态。下一步 ViewGroup/ViewIntersect 剩余矩阵及其他 capability 域。

| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.86，Client domain 100% 关闭（281/281）；View domain 106 个唯一 runtime（新增 ViewGroup 12、ViewIntersect 6；TimeAccum 10/10、TimeLengthBatch 9/9、FirstTime 3/3、ExternallyTimedWin 5/5、ExternallyTimedBatched 5/5、ExpressionWindow 13/13、ExpressionBatch 13/13、LengthBatch 3/8、Union 1 及既有 KeepAll/Length/First/Last/Time/TimeBatch/Sort/FirstUnique/MarketData 子集），Pattern domain 107 个；ExprFilter 32、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,094 条关联、2,094/4,140 唯一 runtime（50.58%）、317 mapped / 1 partial / 17 approved-difference；下一步 ViewGroup/ViewIntersect 剩余矩阵及其他 capability 域 |
