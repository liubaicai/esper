...
| 项目 | 内容 |
|---|---|
| 文档状态 | Draft 3.78，Client domain 100% 关闭（281/281）；View domain 80 个唯一 runtime（TimeAccum 10/10、TimeLengthBatch 9/9、FirstTime 3/3、ExternallyTimedWin 5/5、ExternallyTimedBatched 5/5、ExpressionWindow 13/13、ExpressionBatch 13/13 及既有 KeepAll/Length/First/Last/Time/TimeBatch/Sort/FirstUnique/MarketData 子集），Pattern domain 107 个；ExprFilter 23、ExprEnum 27、ResultSet 2、EPLOther 2、EPLInsertInto 1；manifest 当前 2,067 条关联、2,067/4,140 唯一 runtime（49.93%）、301 mapped / 1 partial / 17 approved-difference；下一步 View Accum 系列与 ExprFilter 剩余 |
