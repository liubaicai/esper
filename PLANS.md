...
- Current target: Draft 4.375 'dataflow-lifecycle-cancel-join' - the 7 YELLOW cancel/join executions (NonBlockingJoinCancel 893c8283ee90019f37fa, NonBlockingJoinException e1bdb19779e28fa49bc2, NonBlockingException 69dbb4e0d879421b52f7, NonBlockingCancel f053fbdc01fad03ba5a6, NonBlockingJoinMultipleRunnable 827b0af4ea14c59da2bc, NonBlockingJoinSingleRunnable a9a21d69ccb78f9fd152, FastCompleteNonBlocking de4fc2179a2cb72a97e6) + the BlockingMultipleRunnable multi-source-run() guard disposition (deferred implemented-not-differential - Go Run has no source-count guard and replaying Java's UnsupportedOperationException shape needs an engine semantic change). Follow-up: remaining 4 (BlockingCancel, FastCompleteBlocking, RunBlocking, BlockingRunJoin-RED); epstatement-pattern/typed-ports dispositions; database slices; DV-list consolidation; perf 4.9.
