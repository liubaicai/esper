...
- Current target: Draft 4.379 'database-dispositions' - disposition closure for case.inventory.epl-database-join's eleven implemented-not-differential executions (TimeBatch triple engine-gap probe finding documented; invalid family compile-path dispositions; MySQLDatabaseConnection raw-JDBC; RestartStatement deferred). Follow-up: TimeBatch engine investigation unit; RestartStatement on real MySQL; epstatement-pattern/typed-ports dispositions; DV-list consolidation; perf 4.9 incremental join.
...
## Current work unit
Active: Draft 4.379 ('database-dispositions').
