...
- Current target: internal property-access metadata caching and stateless filter execution specialization (user-requested performance repair); preserve API, Plan identity, and observable Java/Go behavior. Deferred performance work will be recorded in `docs/esper-go-performance.md`.
