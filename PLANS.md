...
- Current target: Draft 4.377 'database-slices' - first slice over EPLDatabaseJoin (21 executions; manifest case.inventory.epl-database-join lists 17 - reconcile +4 missing: SimpleJoinLeft/Variables/InvalidSQL/ StreamNamesAndRename): ordinals 1/19/15/17/2 (SimpleJoinLeft, SimpleJoinRight, StreamNamesAndRename, PropertyResolution, 2HistoricalStar) via a function-fed Go HistoricalProvider against the mysql:8.0 Docker fixture for the Java oracle. Follow-up: TimeBatch triple, WithPattern, Variables, 3Stream, RestartStatement, invalid family dispositions, MySQLDatabaseConnection defer.
