...
- Current target: Draft 4.316 unit 2 implemented — `case.output-after-events` extended with the time slice (ords 4 DirectTimePeriod + 1 EveryPolicy), now 9 records per side, 0 differences; gates and independent review PASS; commit and push remain. Unit 3 (calendar+snapshot: ords 2,5) remains queued.
## Current work unit
