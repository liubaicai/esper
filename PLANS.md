...
- Current target: Draft 4.316 unit 1 implemented — `case.output-after-events` (ords 3 DirectNumberOfEvents + 6 OutputWhenThen) differential-verified (5 records per side, 0 differences); gates and independent review PASS; commit and push remain. Units 2 (time: ords 4,1) and 3 (calendar+snapshot: ords 2,5) remain queued.
## Current work unit
...
- [x] Update manifest, roadmap, and CHANGELOG.
- [x] Run gates and independent parity review.
- [ ] Commit and push output-after-events unit.
