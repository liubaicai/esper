...
- Current target: Draft 4.315 implemented — `case.resultset-orderby-self-join` differential-verified (4 records per side, 0 differences) with the join-iterator snapshot shape engine fix; gates and independent review PASS; commit and push remain.
## Current work unit
Draft 4.315 status (all checked):
...
- [ ] Commit and push resultset-orderby-self-join unit.
