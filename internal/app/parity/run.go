...
func Run(args []string, stdout, stderr io.Writer) int {
	...
	mode := flags.String("mode", "stage1", "runner mode: stage1, context-hash, context-hash-diff, filter-window-aggregate, filter-window-aggregate-diff, join-length-window, join-length-window-diff, output-policy, output-policy-diff, pattern-timer, pattern-timer-diff, epl-insert-into-transpose-pattern, epl-insert-into-transpose-pattern-diff, infra-faf-scene-two, infra-faf-scene-two-diff, subquery, subquery-diff, named-window-mutation, named-window-mutation-diff, table-mutation, table-mutation-diff, variable-deploy, variable-deploy-diff, context-output, context-output-diff, deployment-restart, deployment-restart-diff, high-cardinality, high-cardinality-diff, time-window, time-window-diff, dataflow-connector, dataflow-connector-diff, output-after, output-after-diff, rollup, rollup-diff, rollup-output-every-sorted, rollup-output-every-sorted-diff, rollup-output-last, rollup-output-last-diff")
