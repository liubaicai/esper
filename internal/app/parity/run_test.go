...
func TestRunHelpSucceeds(t *testing.T) {
	...
	for _, mode := range []string{"resultset-aggregate-minmax-groupby", "resultset-aggregate-minmax-groupby-diff", "resultset-aggregate-minmax-groupby-om-viewcompile", "resultset-aggregate-minmax-groupby-om-viewcompile-diff"} {
