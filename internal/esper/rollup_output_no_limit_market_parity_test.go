...
// TestRollupOutputNoLimitMarketParity mirrors the rollup-output-no-limit-market
// parity scenario (Java ResultSet1NoOutputLimit): a 5.5s SupportMarketDataBean
// window with rollup(symbol) and no output policy.
func TestRollupOutputNoLimitMarketParity(t *testing.T) {
	env := NewEnvironment()
