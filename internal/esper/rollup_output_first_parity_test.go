...
// TestRollupOutputFirstParity mirrors the rollup-output-first parity scenario
// (Java ResultSetOutputFirst{join=false}): an irstream rollup over a 3.5s
// time window emits the first change per group in each virtual-time interval,
// including pure time-expiry batches that post current new rows and previous
// old rows.
func TestRollupOutputFirstParity(t *testing.T) {
	env := NewEnvironment()
	...
	wantNew := [][]rollupOutputLastRowWant{
		...
		{
			{c0: "E1", c1: 1, c2: int64(170)},
			{c0: "E1", c1: nil, c1Null: true, c2: int64(240)},
			{c0: nil, c0Null: true, c1: nil, c1Null: true, c2: int64(280)},
		},
		{
	...
	wantOld := [][]rollupOutputLastRowWant{
		...
		},
		{
			...
			{c0: "E1", c1: 2, c2: int64(50)},
			{c0: "E2", c1: nil, c1Null: true, c2: int64(40)},
			{c0: "E1", c1: nil, c1Null: true, c2: int64(260)},
			{c0: nil, c0Null: true, c1: nil, c1Null: true, c2: int64(300)},
		},
		{
		...
		{
			{c0: "E1", c1: 1, c2: int64(300)},
			{c0: "E1", c1: nil, c1Null: true, c2: int64(300)},
			{c0: nil, c0Null: true, c1: nil, c1Null: true, c2: int64(300)},
		},
	}
