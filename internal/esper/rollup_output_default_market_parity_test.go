...
// TestRollupOutputDefaultMarketParity mirrors the rollup-output-default-market
// parity scenario (Java ResultSet2OutputLimitDefault): a 5.5s SupportMarketDataBean
// window with rollup(symbol) and output every second.
func TestRollupOutputDefaultMarketParity(t *testing.T) {
	env := NewEnvironment()
	...
	want := [][][][2]any{
		{
			{{"IBM", 25.0}, {nil, 25.0}, {"MSFT", 9.0}, {nil, 34.0}},
			{{"IBM", nil}, {nil, nil}, {"MSFT", nil}, {nil, 25.0}},
		},
		{
			{{"IBM", 49.0}, {nil, 58.0}, {"YAH", 1.0}, {nil, 59.0}, {"IBM", 75.0}, {nil, 85.0}},
			{{"IBM", 25.0}, {nil, 34.0}, {"YAH", nil}, {nil, 58.0}, {"IBM", 49.0}, {nil, 59.0}},
		},
		{
			{{"YAH", 3.0}, {nil, 87.0}},
			{{"YAH", 1.0}, {nil, 85.0}},
		...
		{
			{{"IBM", 97.0}, {nil, 109.0}, {"YAH", 6.0}, {nil, 112.0}},
			{{"IBM", 75.0}, {nil, 87.0}, {"YAH", 3.0}, {nil, 109.0}},
		},
		{
			{{"IBM", 72.0}, {nil, 87.0}, {"YAH", 7.0}, {nil, 88.0}},
			{{"IBM", 97.0}, {nil, 112.0}, {"YAH", 6.0}, {nil, 87.0}},
		},
		{
			{{"MSFT", nil}, {nil, 79.0}, {"IBM", 48.0}, {"YAH", 6.0}, {nil, 54.0}},
			{{"MSFT", 9.0}, {nil, 88.0}, {"IBM", 72.0}, {"YAH", 7.0}, {nil, 79.0}},
		},
	}
