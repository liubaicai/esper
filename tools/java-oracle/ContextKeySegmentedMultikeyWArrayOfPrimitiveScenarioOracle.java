...
/**
 * Direct Esper 9.0.0 oracle for the context-key-segmented-multikey-w-array-of-primitive
 ...
 * key.
 */
public final class ContextKeySegmentedMultikeyWArrayOfPrimitiveScenarioOracle {
    private static final String VERSION = "esper-parity/v1";

    private ContextKeySegmentedMultikeyWArrayOfPrimitiveScenarioOracle() {
    }

    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            throw new IllegalArgumentException("usage: ContextKeySegmentedMultikeyWArrayOfPrimitiveScenarioOracle <scenario.json>");
        }
    ...
    private static void runCase(JsonArray allSteps, int caseIndex, String caseName, JsonArray records) throws Exception {
        ...
        EPRuntime runtime = EPRuntimeProvider.getRuntime("parity-context-keyed-multikey-array", configuration);
