...
/**
 * Direct Esper 9.0.0 oracle for the context-key-segmented-w-init-term-pattern-as-name
 ...
 * key.
 */
public final class ContextKeySegmentedWInitTermPatternAsNameScenarioOracle {
    private static final String VERSION = "esper-parity/v1";

    private ContextKeySegmentedWInitTermPatternAsNameScenarioOracle() {
    }

    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            throw new IllegalArgumentException("usage: ContextKeySegmentedWInitTermPatternAsNameScenarioOracle <scenario.json>");
        }
    ...
    private static void runCase(JsonArray allSteps, int caseIndex, String caseName, JsonArray records) throws Exception {
        ...
        EPRuntime runtime = EPRuntimeProvider.getRuntime("parity-context-keyed-init-term-pattern-name", configuration);
