...
/**
 * Direct Esper 9.0.0 oracle for the context-key-segmented-w-init-term-end-event
 ...
 * key.
 */
public final class ContextKeySegmentedWInitTermEndEventScenarioOracle {
    private static final String VERSION = "esper-parity/v1";

    private ContextKeySegmentedWInitTermEndEventScenarioOracle() {
    }

    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            throw new IllegalArgumentException("usage: ContextKeySegmentedWInitTermEndEventScenarioOracle <scenario.json>");
        }
    ...
    private static void runCase(JsonArray allSteps, int caseIndex, String caseName, JsonArray records) throws Exception {
        ...
        EPRuntime runtime = EPRuntimeProvider.getRuntime("parity-context-keyed-init-term-end", configuration);
