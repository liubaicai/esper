 ...
 * ResultSetJoinAll and ResultSetJoinLast.
 */
public final class RollupOutputLastScenarioOracle {
    ...
    private static void runCase(JsonArray allSteps, String caseName, JsonArray records) throws Exception {
        ...
        if ("snapshot".equals(caseName) || "last-market".equals(caseName) || "first-market".equals(caseName) || "no-limit-market".equals(caseName) || "default-market".equals(caseName) || "default".equals(caseName) || "last-aggregate".equals(caseName) || "no-output".equals(caseName) || "default-output".equals(caseName) || "default-having".equals(caseName) || "last-output".equals(caseName) || "last-having".equals(caseName) || "first-output".equals(caseName) || "snapshot-output".equals(caseName) || "all-output".equals(caseName) || "having-output".equals(caseName) || "max-output".equals(caseName) || "none-join".equals(caseName) || "none-having-join".equals(caseName) || "default-join".equals(caseName) || "default-having-join".equals(caseName) || "last-join".equals(caseName) || "last-having-join".equals(caseName) || "first-join".equals(caseName) || "all-time".equals(caseName) || "all-join".equals(caseName) || "all-having".equals(caseName) || "all-having-join".equals(caseName) || "default-join2".equals(caseName) || "all-join2".equals(caseName) || "last-join2".equals(caseName)) {
