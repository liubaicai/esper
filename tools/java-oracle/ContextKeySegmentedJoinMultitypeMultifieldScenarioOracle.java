...
/**
 * Direct Esper 9.0.0 oracle for the context-key-segmented-join-multitype-multifield parity
 ...
 */
public final class ContextKeySegmentedJoinMultitypeMultifieldScenarioOracle {
    private static final String VERSION = "esper-parity/v1";

    private ContextKeySegmentedJoinMultitypeMultifieldScenarioOracle() {
    }

    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            throw new IllegalArgumentException("usage: ContextKeySegmentedJoinMultitypeMultifieldScenarioOracle <scenario.json>");
        }
    ...
    private static void runCase(JsonArray allSteps, int caseIndex, String caseName, JsonArray records) throws Exception {
        ...
        EPRuntime runtime = EPRuntimeProvider.getRuntime("parity-context-keyed-join-multitype", configuration);
        ((EPRuntimeSPI) runtime).initialize(0L);
        try {
            String epl;
            String listenerStatement;
            switch (caseName) {
                case "join-multitype-multifield":
                    epl = "@Name('context') @public create context SegmentedBy2Fields " +
