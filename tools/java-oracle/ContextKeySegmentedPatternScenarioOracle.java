...
/**
 * Direct Esper 9.0.0 oracle for the context-key-segmented-pattern
 ...
 * key.
 */
public final class ContextKeySegmentedPatternScenarioOracle {
    private static final String VERSION = "esper-parity/v1";

    private ContextKeySegmentedPatternScenarioOracle() {
    }

    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            throw new IllegalArgumentException("usage: ContextKeySegmentedPatternScenarioOracle <scenario.json>");
        }
    ...
    private static void runCase(JsonArray allSteps, int caseIndex, String caseName, JsonArray records) throws Exception {
        ...
        EPRuntime runtime = EPRuntimeProvider.getRuntime("parity-context-keyed-pattern", configuration);
        ((EPRuntimeSPI) runtime).initialize(0L);
        try {
            String epl = "@public create context SegmentedByString partition by theString from SupportBean;\n" +
